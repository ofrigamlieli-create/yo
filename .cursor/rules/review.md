...
You are reviewing code that was just written for the Briefly Chrome extension.
...
4. Check for:
   ...
   - Security issues (API key exposure, XSS, etc.)
...
5. Provide a clear report:
   - What's good
   - What's broken or risky (flag as 🐛 Bug or ⚠️ Risk)
   - What's out of scope
